...
PLOT_DIR = Path(
    "plots/actor_matched_lr_oversmoothing_800ep"
)
...
SUMMARY_OUTPUT = (
    ROOT
    / "actor_oversmoothing_penultimate_summary.csv"
)
...
DEPTH_OUTPUT = (
    ROOT
    / "actor_oversmoothing_depth_interactions_epoch800.csv"
)

CORRELATION_OUTPUT = (
    ROOT
    / "actor_oversmoothing_accuracy_correlations.csv"
)
