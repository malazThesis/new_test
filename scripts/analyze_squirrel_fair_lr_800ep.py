...
PLOT_DIR = Path(
    "plots/squirrel_fair_lr_800ep"
)

RUN_OUTPUT = (
    RUN_ROOT
    / "squirrel_fair_lr_800ep_run_level.csv"
)

LR_SUMMARY_OUTPUT = (
    RUN_ROOT
    / "squirrel_fair_lr_800ep_summary.csv"
)

SELECTED_OUTPUT = (
    RUN_ROOT
    / "squirrel_fair_lr_800ep_selected_configs.csv"
)

PAIRED_OUTPUT = (
    RUN_ROOT
    / "squirrel_fair_lr_800ep_selected_paired_tests.csv"
)

MATCHED_LR_OUTPUT = (
    RUN_ROOT
    / "squirrel_fair_lr_800ep_matched_lr_effects.csv"
)
...
def make_plots(
    ...
    for depth in DEPTH_ORDER:
        ...
        plt.title(
            f"Squirrel validation tuning, L{depth}"
        )
        plt.legend()
        plt.tight_layout()
        ...
        plt.title(
            f"Squirrel test performance, L{depth}"
        )
        plt.legend()
        plt.tight_layout()
