...
plot_dir = os.path.expanduser("~/gnn_thesis_cluster/plots/all_realworld_baselines_old_vs_new")
...
roman_phase1 = pd.read_csv(
    os.path.expanduser("~/gnn_thesis_cluster/runs/roman_empire_phase1_baselines/roman_empire_phase1_baselines_grouped.csv")
)
roman_phase2 = pd.read_csv(
    os.path.expanduser("~/gnn_thesis_cluster/runs/roman_empire_phase2_baselines/roman_empire_phase2_baselines_grouped.csv")
)
amazon_phase1 = pd.read_csv(
    os.path.expanduser("~/gnn_thesis_cluster/runs/amazon_photo_phase1_baselines/amazon_photo_phase1_baselines_grouped.csv")
)
amazon_phase2 = pd.read_csv(
    os.path.expanduser("~/gnn_thesis_cluster/runs/amazon_photo_phase2_baselines/amazon_photo_phase2_baselines_grouped.csv")
)

old_phase1 = old_phase1[old_phase1["model"].isin(baseline_models)].copy()
old_phase2 = old_phase2[old_phase2["model"].isin(baseline_models)].copy()
...
phase1_best.to_csv(
    os.path.expanduser("~/gnn_thesis_cluster/runs/all_realworld_baselines_phase1_best_by_dataset.csv"),
    index=False
)
phase2_best.to_csv(
    os.path.expanduser("~/gnn_thesis_cluster/runs/all_realworld_baselines_phase2_best_by_dataset.csv"),
    index=False
)
...
make_plot(
    phase1_best,
    "All Real-World Baselines - Phase 1 Best by Dataset",
    "all_realworld_baselines_phase1_best_by_dataset.png",
)

make_plot(
    phase2_best,
    "All Real-World Baselines - Phase 2 Best by Dataset",
    "all_realworld_baselines_phase2_best_by_dataset.png",
)
