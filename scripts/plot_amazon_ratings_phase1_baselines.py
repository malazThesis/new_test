...
RUN_DIR = "runs/amazon_ratings_phase1_baselines"
PLOT_DIR = "plots/amazon_ratings_phase1_baselines"
...
def main():
    ...
    plt.title("Amazon-Ratings Phase 1 Baselines")
    ...
    depth_path = os.path.join(
        PLOT_DIR,
        "amazon_ratings_phase1_baselines_depth.png",
    )
    ...
    plt.ylabel("Mean Best Test Accuracy")
    plt.title(
        "Amazon-Ratings Phase 1 Baselines – Best Configuration per Model"
    )
    plt.tight_layout()

    bar_path = os.path.join(
        PLOT_DIR,
        "amazon_ratings_phase1_baselines_best_bar.png",
    )
