...
RUN_OUTPUT = (
    RUN_ROOT
    / "actor_fair_lr_run_level.csv"
)

LR_SUMMARY_OUTPUT = (
    RUN_ROOT
    / "actor_fair_lr_summary.csv"
)

SELECTED_OUTPUT = (
    RUN_ROOT
    / "actor_fair_lr_selected_configs.csv"
)

PAIRED_OUTPUT = (
    RUN_ROOT
    / "actor_fair_lr_selected_paired_tests.csv"
)

MATCHED_LR_OUTPUT = (
    RUN_ROOT
    / "actor_fair_lr_matched_lr_effects.csv"
)
