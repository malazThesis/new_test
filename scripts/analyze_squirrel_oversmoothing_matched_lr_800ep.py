...
PLOT_DIR = Path(
    "plots/squirrel_matched_lr_oversmoothing_800ep"
)

PENULTIMATE_OUTPUT = (
    ROOT
    / "squirrel_oversmoothing_penultimate_run_level.csv"
)

SUMMARY_OUTPUT = (
    ROOT
    / "squirrel_oversmoothing_penultimate_summary.csv"
)
...
DEPTH_OUTPUT = (
    ROOT
    / "squirrel_oversmoothing_depth_interactions_epoch800.csv"
)

CORRELATION_OUTPUT = (
    ROOT
    / "squirrel_oversmoothing_accuracy_correlations.csv"
)

ACCURACY_OUTPUT = (
    ROOT
    / "squirrel_oversmoothing_accuracy_run_level.csv"
)
