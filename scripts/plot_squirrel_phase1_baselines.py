...
RUN_DIR = "runs/squirrel_phase1_baselines"
PLOT_DIR = "plots/squirrel_phase1_baselines"
...
def main():
    ...
    # Vergleich nach Tiefe und Hidden-Dimension
    ...
    plt.title("Squirrel Phase 1 Baselines")
    ...
    depth_path = os.path.join(
        PLOT_DIR,
        "squirrel_phase1_baselines_depth.png",
    )
    ...
    plt.ylabel("Mean Best Test Accuracy")
    plt.title(
        "Squirrel Phase 1 Baselines – Best Configuration per Model"
    )
    plt.tight_layout()

    bar_path = os.path.join(
        PLOT_DIR,
        "squirrel_phase1_baselines_best_bar.png",
    )
