...
PLOT_DIR = Path(
    "plots/roman_empire_fair_lr_800ep"
)
...
LR_SUMMARY_OUTPUT = (
    RUN_ROOT
    / "roman_empire_fair_lr_800ep_summary.csv"
)

SELECTED_OUTPUT = (
    RUN_ROOT
    / "roman_empire_fair_lr_800ep_selected_configs.csv"
)

PAIRED_OUTPUT = (
    RUN_ROOT
    / "roman_empire_fair_lr_800ep_selected_paired_tests.csv"
)

MATCHED_LR_OUTPUT = (
    RUN_ROOT
    / "roman_empire_fair_lr_800ep_matched_lr_effects.csv"
)
