...
PLOT_DIR = Path(
    "plots/amazon_ratings_fair_lr_800ep"
)

RUN_OUTPUT = (
    RUN_ROOT
    / "amazon_ratings_fair_lr_800ep_run_level.csv"
)
...
SELECTED_OUTPUT = (
    RUN_ROOT
    / "amazon_ratings_fair_lr_800ep_selected_configs.csv"
)

PAIRED_OUTPUT = (
    RUN_ROOT
    / "amazon_ratings_fair_lr_800ep_selected_paired_tests.csv"
)

MATCHED_LR_OUTPUT = (
    RUN_ROOT
    / "amazon_ratings_fair_lr_800ep_matched_lr_effects.csv"
)
