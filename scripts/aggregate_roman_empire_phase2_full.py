...
out_full_csv = os.path.join(run_dir, "roman_empire_phase2_full_summary.csv")
out_grouped_csv = os.path.join(run_dir, "roman_empire_phase2_full_grouped.csv")
out_best_csv = os.path.join(run_dir, "roman_empire_phase2_full_best_grouped.csv")
